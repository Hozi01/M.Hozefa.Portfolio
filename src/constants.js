...
import newtonschoolLogo1 from './assets/company_logo/newtonschool_logo1.png';
...
export const SkillsInfo = [
  {
    title: 'Softwares',
    skills: [
      { name: 'BLENDER', logo: htmlLogo },
      { name: 'Unreal Engine', logo: cssLogo },
      { name: 'Substance Painter', logo: sassLogo },
      { name: 'AfterEffects', logo: javascriptLogo },
      { name: 'Premier Pro', logo: reactjsLogo },
      { name: 'Photoshop', logo: angularLogo },
      { name: 'Adobe Illustrator', logo: reduxLogo },
      { name: 'Adobe Audition', logo: nextjsLogo },
      { name: 'Media Encoder', logo: tailwindcssLogo }, 
    ],
  },
];
...
,
      ...
      webapp: "https://www.behance.net/gallery/193096175/Fortnite-Battle-Bus-In-Blender",
    },
    {
      id: 8,
